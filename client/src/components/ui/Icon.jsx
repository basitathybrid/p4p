export function Icon({ name, className = '' }) {
  ...
  const icons = {
    ...
    wallet: (<svg {...common}><path d="M4 8.2A2.7 2.7 0 0 1 6.7 5.5h9.6A2.7 2.7 0 0 1 19 8.2v.6h.3A2.2 2.2 0 0 1 21.5 11v5.3a2.7 2.7 0 0 1-2.7 2.7H6.7A2.7 2.7 0 0 1 4 16.3V8.2Z" fill="currentColor" fillOpacity="0.95" stroke="none" /><path d="m14.6 6 4.6-1.7" strokeWidth="1.6" /><circle cx="16.8" cy="13.5" r="1.5" fill="#170a2e" stroke="none" /></svg>),
    table: (<svg {...common}><path d="M4 7h16M4 12h16M4 17h16M8 4v16M16 4v16" /></svg>),
    chart: (<svg {...common}><path d="M5 18V7M12 18V4M19 18v-9" /><path d="M3.5 18.5h17" /></svg>),
    'tier-config': (<svg {...common}><path d="M12 4.5 18 7v4.7c0 3.4-1.8 6.5-6 9.3-4.2-2.8-6-5.9-6-9.3V7l6-2.5Z" /><path d="M9.5 11.3 11.1 12.9 14.8 9.2" /><path d="M8.5 15.5h7" /></svg>),
    reports: (<svg {...common}><path d="M5.5 18.5V9.5" /><path d="M11.5 18.5v-6" /><path d="M17.5 18.5v-11" /><path d="M3.5 18.5h17" /><path d="M8.5 5.5 11.5 8.5l3-3" /></svg>),
    audit: (<svg {...common}><path d="M8 4.5h8l3 3v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-13a2 2 0 0 1 2-2Z" /><path d="M8 4.5v4h8v-4" /><path d="M8.5 12.5h7M8.5 15.5h7" /><path d="M9.5 9.5h5" /></svg>),
    settings: (<svg {...common}><circle cx="12" cy="12" r="3" /><path d="M19.5 12a7.6 7.6 0 0 0-.1-1.1l2-1.5-2-3.4-2.5 1a7.8 7.8 0 0 0-1.9-1.1L14.5 3h-5l-.5 2.9a7.8 7.8 0 0 0-1.9 1.1l-2.5-1-2 3.4 2 1.5A7.6 7.6 0 0 0 4.5 12c0 .4 0 .7.1 1.1l-2 1.5 2 3.4 2.5-1c.6.5 1.2.9 1.9 1.1l.5 2.9h5l.5-2.9c.7-.2 1.3-.6 1.9-1.1l2.5 1 2-3.4-2-1.5c.1-.4.1-.7.1-1.1Z" /></svg>),
    star: (<svg {...common}><path d="m12 3 2.6 5.4 5.9.8-4.2 4.1 1 5.9L12 0 6.7 19.2l1-5.9-4.2-4.1 5.9-.8L12 3Z" /></svg>),
    crown: (<svg {...common}><path d="M4 8.5 8 12l4-6 4 6 4-3.5-1.4 9.5H5.4L4 8.5Z" /><path d="M5.5 19.5h13" /></svg>),
